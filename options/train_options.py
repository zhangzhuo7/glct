...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--eval_epoch_freq', type=int, default=5, help='frequency of eval checkpoints at the end of epochs')
        ...
        parser.add_argument('--is', type=str, default=None, help='resume training from another checkpoint')
